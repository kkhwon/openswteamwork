...
export default function RecordView({
  ...
  const MOODS_META = [
    { name: "집중", icon: Target, activeClr: "bg-pastel-400 text-white shadow-md shadow-pastel-100", label: "집중" },
    { name: "휴식", icon: Moon, activeClr: "bg-violet-650 text-white shadow-md shadow-violet-100", label: "휴식" },
    ...
    { name: "불안", icon: Brain, activeClr: "bg-indigo-650 text-white shadow-md shadow-indigo-100", label: "불안" }
  ] as const;
    ...
    <div id="record-view-container" className="flex flex-col h-full bg-slate-50 text-slate-850">
      ...
      <header className="flex justify-between items-center px-5 py-4 bg-white border-b border-slate-100">
        <div className="flex items-center space-x-2">
          <Layers className="w-5 h-5 text-pastel-500" />
          <h1 className="font-bold text-lg text-slate-900 tracking-tight">기록 & 명언</h1>
        </div>
        <Sparkles className="w-5 h-5 text-pastel-400 animate-pulse" />
      </header>
              ...
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-base font-bold text-slate-850 flex items-center">
                    <span className="w-2.5 h-2.5 rounded-full bg-pastel-400 mr-2" />
                    성장기록 타임캡슐
                  </h2>
                ...
                <button
                  ...
                  className="bg-pastel-50 hover:bg-pastel-100 text-pastel-700 font-bold text-xs px-3.5 py-1.5 rounded-xl flex items-center gap-1 cursor-pointer transition-colors border border-pastel-200/50"
                >
                ...
                {activeCapsuleForm && (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      className="w-full text-xs font-medium bg-white border border-slate-200 rounded-xl p-3 focus:outline-none focus:border-pastel-400 text-slate-800 placeholder-slate-350 resize-none"
                      rows={3}
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-pastel-400 text-white rounded-xl text-xs font-bold hover:bg-pastel-500 active:scale-95 transition-all text-center cursor-pointer"
                    >
                      오늘의 다짐 엽서 잠그기
                    </button>
                  </motion.div>
                        ...
                        >
                          ...
                          <div className="flex items-center space-x-1 shrink-0 self-start">
                            <button
                              ...
                              className="p-1 rounded-lg text-slate-400 hover:text-pastel-600 hover:bg-pastel-50 transition-colors cursor-pointer"
                              title="수정하기"
                            >
            ...
            <div id="mood-recommends-container" className="bg-white rounded-3xl p-5 border border-slate-100 shadow-xs space-y-4">
              ...
              <div className="bg-slate-50/50 p-4 rounded-2xl border border-slate-100/60 relative">
                <h3 className="text-xs font-extrabold text-slate-500 mb-2.5 uppercase tracking-wider flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-pastel-400 mr-1.5" />
                ...
                {loadingSuggestions ? (
                  <div className="py-6 text-center text-xs text-slate-400 font-medium flex items-center justify-center gap-1.5">
                    <RefreshCw className="w-4 h-4 animate-spin text-pastel-400" />
                  ...
                  <div className="space-y-2">
                    {suggestions.map((taskStr, sIdx) => {
                      ...
                      return (
                        <div 
                          key={sIdx}
                          className="bg-white rounded-xl p-3 border border-slate-150 flex justify-between items-center hover:border-pastel-300 transition-colors cursor-pointer group"
                          ...
                          <button 
                            className={`
                              ...
                              ${wasRecentlyAdded
                                ...
                                : "bg-pastel-50 text-pastel-700 border-pastel-100 hover:bg-pastel-400 hover:text-white"
                              }
                            `}
                          >
                            {wasRecentlyAdded ? (
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-4">
                    <div className="w-14 h-14 rounded-full bg-pastel-50 flex items-center justify-center mx-auto text-pastel-600 mb-2">
                    ...
                    <button
                      onClick={() => setFocusedCapsule(null)}
                      className="w-full py-2.5 bg-pastel-400 text-white font-bold text-xs rounded-xl hover:bg-pastel-500 cursor-pointer"
                    >
                      돌아가기
                    </button>
                  </div>
