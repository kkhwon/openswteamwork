...
export default function CalendarView({
  ...
  const getCategoryColor = (cat: Category) => {
    switch (cat) {
      case "학습": return "bg-pastel-100 text-pastel-700 border-pastel-250 hover:bg-pastel-200";
      case "과제": return "bg-indigo-50 text-indigo-700 border-indigo-150 hover:bg-indigo-100";
      case "개인": return "bg-purple-100 text-purple-700 border-purple-200 hover:bg-purple-200";
    ...
    <div id="calendar-view-container" className="flex flex-col h-full bg-slate-50 text-slate-800">
      ...
      <header className="flex justify-between items-center px-5 py-4 bg-white border-b border-slate-100">
        <div className="flex items-center space-x-2">
          <CalendarIcon className="w-5 h-5 text-pastel-400" />
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="p-1.5 rounded-full bg-slate-100 hover:bg-slate-200 cursor-pointer">
            <span className="text-[10px] font-bold text-pastel-500 px-0.5">2026</span>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 overflow-y-auto px-4 md:px-6 py-5 pb-24">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="bg-white rounded-3xl p-5 shadow-xs border border-slate-100">
              <div className="grid grid-cols-7 text-center text-xs font-black pb-3.5 border-b border-slate-100 text-slate-400">
                ...
                <span>목</span>
                <span>금</span>
                <span className="text-pastel-400">토</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`
                        ...
                        ${isSelected ? "bg-pastel-300 text-slate-850 shadow-md shadow-pastel-100" : ""}
                        ${!isSelected && isToday ? "border-2 border-pastel-300 text-pastel-600" : ""}
                      ...
                      `}>
                        ...
                        {cellCompleted && !isSelected && d.dateString !== "2026-06-13" && (
                          <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-pastel-400 rounded-full" />
                        )}
                      </div>
                      ...
                      <div className="h-4 flex items-center justify-center mt-0.5">
                        {cellHasTodo && (
                          <span className={`w-1.5 h-1.5 rounded-full ${cellCompleted ? "bg-pastel-500" : "border border-pastel-300 bg-white"}`} />
                        )}
                      </div>
                    </div>
                  );
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[11px] text-slate-500 font-semibold">
                <div className="flex items-center space-x-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-pastel-300 shrink-0" />
                  <span>하늘색 점: 하루 루틴 100% 완료</span>
                </div>
                <div className="flex items-center space-x-1.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-teal-500 shrink-0" />
                  <span>초록색 체크: 완료 기념일 마커</span>
                </div>
                <div className="flex items-center space-x-1.5 font-sans">
                  <span className="w-2.5 h-2.5 rounded-full border border-pastel-300 bg-white shrink-0" />
                  <span>빈 원형: 아직 완료 진행 중인 남은 할 일 존재</span>
                </div>
              </div>
            </div>

            {/* BOTTOM MOTIVATIVE QUOTE BANNER */}
            <div className="bg-gradient-to-br from-indigo-50 to-pastel-50/50 rounded-3xl p-5 border border-indigo-150/50 relative overflow-hidden hidden lg:block">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white rounded-3xl p-5 shadow-xs border border-slate-100">
              <div className="flex justify-between items-center pb-3.5 border-b border-slate-100">
                <div>
                  ...
                  <span className="text-[10px] bg-pastel-50 text-pastel-600 font-extrabold px-2.5 py-0.5 rounded-full">
                    일과 {currentDayTodos.length}개
                  </span>
                </div>
                {currentDayStats.total > 0 && (
                  <span className="text-xs font-bold text-pastel-600 font-mono">
                ...
                <div className="mt-3.5">
                  <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                    <motion.div 
                      ...
                      className="bg-pastel-400 h-2 rounded-full"
                    />
                  </div>
                </div>
              ) : (
                      ...
                      <motion.div
                        ...
                        className={`
                          ...
                          ${item.completed 
                            ...
                            : "border-slate-100 hover:shadow-xs group hover:border-pastel-300"
                          }
                        `}
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex items-start space-x-3.5 flex-1 min-w-0">
                            ...
                            >
                              {item.completed ? (
                                <CheckCircle2 className="w-5.5 h-5.5 text-pastel-500 fill-pastel-50" />
                              ) : (
                                <Circle className="w-5.5 h-5.5 text-slate-250 hover:text-pastel-400 transition-colors" />
                              )}
                            </button>
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex space-x-3.5 mt-1 text-[11px] text-slate-400 font-medium">
                                ...
                                {item.notify && (
                                  <span className="flex items-center text-pastel-500 font-semibold">
                              ...
                              {!item.completed && (
                                <div className="mt-3 pt-2.5 border-t border-slate-50">
                                  <div className="flex justify-between items-center mb-1">
                                    ...
                                    <span className="text-[10px] font-bold text-pastel-600 font-mono">{item.progress}%</span>
                                  </div>
                                  <div className="flex items-center space-x-2">
                                    <input 
                                      type="range" 
                          ...
                          <div className="flex items-center space-x-1 ml-1.5 shrink-0 self-start">
                            <button 
                              ...
                              className="p-1.5 rounded-xl text-slate-400 hover:text-pastel-500 hover:bg-slate-50 transition-all cursor-pointer"
                              title="수정하기"
                            >
                            ...
                            <button 
                              ...
                              className="p-1.5 rounded-xl text-slate-400 hover:text-rose-500 hover:bg-slate-50 transition-all cursor-pointer"
                              title="삭제하기"
                            >
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-pastel-50/50 rounded-2xl p-5 border border-indigo-150/50 text-center relative overflow-hidden lg:hidden">
      ...
      <button 
        ...
        className="fixed bottom-20 right-6 w-14 h-14 bg-pastel-300 text-slate-800 rounded-full flex items-center justify-center shadow-lg shadow-pastel-100 hover:bg-pastel-400 hover:scale-105 active:scale-95 transition-all z-40 cursor-pointer border border-pastel-200"
        id="btn-add-todo"
      >
          ...
          >
            ...
            >
              <div className="flex justify-between items-center pb-4 border-b border-slate-100">
                <div className="flex items-center space-x-2">
                  <span className="p-1 w-7 h-7 rounded-lg bg-pastel-100 text-pastel-600 flex items-center justify-center">
              ...
              <form onSubmit={handleSaveEditTodo} className="space-y-4 pt-4">
                ...
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className="w-full text-xs font-semibold bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-none focus:border-pastel-400 ... select-none focus:bg-white text-slate-855"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full text-xs font-bold bg-slate-50 border border-slate-200 rounded-xl p-2.5 focus:outline-none focus:border-pastel-400 focus:bg-white text-slate-700 cursor-pointer"
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full text-xs font-semibold bg-slate-50 border border-slate-200 rounded-xl p-2.5 focus:outline-none focus:border-pastel-400 focus:bg-white text-slate-755"
                    />
                  </div>
                ...
                <div className="space-y-1.5 p-3.5 bg-slate-50 rounded-2xl border border-slate-100">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs font-bold text-pastel-600 font-mono">{editingTodo.progress}%</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <input 
                      type="range"
                      ...
                      className="w-full h-1 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-pastel-400"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea 
                    ...
                    rows={2}
                    className="w-full text-xs font-medium bg-slate-50 border border-slate-200 rounded-xl p-3 focus:outline-none focus:border-pastel-400 focus:bg-white text-slate-800 placeholder-slate-350 resize-none animate-none"
                ...
                <div className="flex justify-between items-center py-1">
                  <div className="flex items-center space-x-1">
                    <Bell className="w-3.5 h-3.5 text-pastel-400" />
                ...
                <div className="flex space-x-3 pt-3">
                  ...
                  <button 
                    type="submit"
                    className="flex-1 py-2.5 bg-pastel-400 hover:bg-pastel-500 text-white font-bold text-xs rounded-xl shadow-md shadow-pastel-100 transition-all cursor-pointer text-center"
                  >
                    수정 완료
                  </button>
                </div>
