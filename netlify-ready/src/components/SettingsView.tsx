      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 pb-28 space-y-6">
        ...
        <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-xs space-y-3.5">
          <h2 className="text-sm font-bold text-slate-800 flex items-center">
            <span className="w-2 mr-2 h-2.5 rounded bg-blue-500" />
            사용자 성찰 프로필
          </h2>
          ...
          <div className="space-y-2">
            ...
            <div className="flex space-x-2.5">
              <input 
                type="text" 
                className="flex-1 text-xs font-bold bg-slate-100 rounded-xl px-4 py-2.5 border-none focus:outline-none focus:ring-2 focus:ring-blue-100 text-slate-800"
                value={userName}
                onChange={(e) => setUserName(e.target.value)}
              />
              <button
                onClick={handleUpdateName}
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs px-4 py-1 rounded-xl shadow-sm cursor-pointer transition-all active:scale-95"
              >
                변경
              </button>
            </div>
        ...
        <div className="bg-slate-100 rounded-3xl p-5 border border-slate-150 text-center space-y-2">
          ...
          <span className="text-[9px] font-extrabold text-blue-600 block bg-blue-50/70 p-1 rounded-full border border-blue-100 max-w-max mx-auto px-3">
