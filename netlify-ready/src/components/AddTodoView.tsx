  ...
  return (
    <div id="add-todo-container" className="flex flex-col h-full bg-slate-50 text-slate-800">
      ...
      <header className="flex justify-between items-center px-5 py-4 bg-white border-b border-slate-100">
        ...
        <button 
          onClick={handleSave}
          className="p-1 rounded-full hover:bg-slate-100 text-blue-600 cursor-pointer"
          disabled={!title.trim()}
          id="btn-save-check"
        >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5 pb-24">
        ...
        <div className="space-y-1.5">
          ...
          <input 
            ...
            className="w-full text-sm font-semibold bg-white border border-slate-200/80 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all text-slate-800 placeholder-slate-300"
            value={title}
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative flex items-center">
            ...
            <input 
              type="date"
              className="w-full text-sm font-semibold bg-white border border-slate-200/80 rounded-xl pl-11 pr-4 py-3 focus:outline-none focus:border-blue-500 transition-all text-slate-850"
              value={dueDate}
          ...
          <div className="grid grid-cols-3 gap-2">
            {(["높음", "보통", "낮음"] as Priority[]).map((p) => {
              ...
              if (isSel) {
                ...
                else if (p === "보통") btnClass = "bg-blue-50 text-blue-700 border-blue-200 font-bold";
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              { name: "학습", icon: BookOpen, color: "hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200" },
              { name: "과제", icon: FileText, color: "hover:bg-sky-50 hover:text-sky-600 hover:border-sky-200" },
        ...
        <div className="space-y-1.5">
          ...
          <textarea 
            ...
            rows={3}
            className="w-full text-sm font-medium bg-white border border-slate-200/80 rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all text-slate-800 placeholder-slate-300 resize-none"
            value={memo}
        ...
        <div className="bg-white rounded-xl border border-slate-150/80 divide-y divide-slate-100">
          ...
          <div className="flex items-center justify-between p-3.5">
            ...
            <label className="relative inline-flex items-center cursor-pointer select-none">
              ...
              />
              <div className="w-9 h-5 bg-slate-200 rounded-full peer peer-focus:ring-2 peer-focus:ring-blue-100 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
            </label>
          </div>
        ...
        <button 
          ...
          className={`
            ...
            ${title.trim() 
              ? "bg-blue-600 text-white hover:bg-blue-700 shadow-blue-100 hover:shadow-lg active:scale-[0.98]" 
